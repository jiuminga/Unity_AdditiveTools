...
public class Parser_CSharp : Parser_Base
{
    private static Parser_CSharp instance;
    public static Parser_CSharp Instance { get { return instance ?? new Parser_CSharp(); } }
    ...
    public readonly ParseNode_Id Directive_ExternAlias = I("externAliasDirective");
    ...
    public readonly ParseNode_Id Declaration_Namespace = I("Declaration_Namespace");
    public readonly ParseNode_Id Declaration_namespaceMember = I("namespaceMemberDeclaration");
    public readonly ParseNode_Id Declaration_class = I("classDeclaration");
    public readonly ParseNode_Id Declaration_struct = I("structDeclaration");
    public readonly ParseNode_Id Declaration_Constant = I("Declaration_Constant");
    public readonly ParseNode_Id Declaration_Field = I("Declaration_Field");
    public readonly ParseNode_Id Declaration_method = I("methodDeclaration");
    public readonly ParseNode_Id Declaration_property = I("propertyDeclaration");
    public readonly ParseNode_Id Declaration_event = I("eventDeclaration");
    public readonly ParseNode_Id Declaration_delegate = I("delegateDeclaration");
    public readonly ParseNode_Id Declaration_indexer = I("indexerDeclaration");
    public readonly ParseNode_Id Declaration_operator = I("operatorDeclaration");
    public readonly ParseNode_Id Declaration_constructor = I("constructorDeclaration");
    public readonly ParseNode_Id Declaration_destructor = I("destructorDeclaration");
    public readonly ParseNode_Id Declaration_accessors = I("accessorDeclarations");
    public readonly ParseNode_Id Declaration_getAccessor = I("getAccessorDeclaration");
    public readonly ParseNode_Id Declaration_setAccessor = I("setAccessorDeclaration");
    public readonly ParseNode_Id Declaration_classMember = I("classMemberDeclaration");
    public readonly ParseNode_Id Declaration_eventWithAccessors = I("eventWithAccessorsDeclaration");
    public readonly ParseNode_Id Declaration_conversionOperator = I("conversionOperatorDeclaration");
    public readonly ParseNode_Id Declaration_eventAccessors = I("eventAccessorDeclarations");
    public readonly ParseNode_Id Declaration_addAccessor = I("addAccessorDeclaration");
    public readonly ParseNode_Id Declaration_removeAccessor = I("removeAccessorDeclaration");

    public readonly ParseNode_Id Declaration_enum = I("enumDeclaration");
    public readonly ParseNode_Id Declaration_enumMember = I("enumMemberDeclaration");
    public readonly ParseNode_Id Declaration_enumMembers = I("enumMemberDeclarations");

    public readonly ParseNode_Id Declaration_interface = I("interfaceDeclaration");
    public readonly ParseNode_Id Declaration_interfaceMember = I("interfaceMemberDeclaration");
    public readonly ParseNode_Id Declaration_interfaceMethod = I("interfaceMethodDeclaration");
    public readonly ParseNode_Id Declaration_interfaceEvent = I("interfaceEventDeclaration");
    public readonly ParseNode_Id Declaration_interfaceProperty = I("interfacePropertyDeclaration");
    public readonly ParseNode_Id Declaration_interfaceIndexer = I("interfaceIndexerDeclaration");
    public readonly ParseNode_Id Declaration_interfaceAccessors = I("interfaceAccessorDeclarations");
    public readonly ParseNode_Id Declaration_interfaceGetAccessor = I("interfaceGetAccessorDeclaration");
    public readonly ParseNode_Id Declaration_interfaceSetAccessor = I("interfaceSetAccessorDeclaration");

    public readonly ParseNode_Id Body_Namespace = I("Body_Namespace");
    public readonly ParseNode_Id Body_Class = I("classBody");
    public readonly ParseNode_Id Body_Method = I("methodBody");
    ...
    public readonly ParseNode_Id List_interfaceType = I("interfaceTypeList");
    public readonly ParseNode_Id List_Argument = I("argumentList");
    public readonly ParseNode_Id List_TypeParameter = I("typeParameterList");
    ...
    public readonly ParseNode_Id Declarator_constructor = I("constructorDeclarator");
    public readonly ParseNode_Id Declarator_destructor = I("destructorDeclarator");
    ...
    public readonly ParseNode_Id PARTIAL = I("PARTIAL");
    ...
    public readonly ParseNode_Id constructorBody = I("constructorBody");
    public readonly ParseNode_Id constructorInitializer = I("constructorInitializer");
    public readonly ParseNode_Id destructorBody = I("destructorBody");
    ...
    public readonly ParseNode_Id block = I("block");
    public readonly ParseNode_Id statementList = I("statementList");
    ...
    public readonly ParseNode_Id structInterfaces = I("structInterfaces");
    public readonly ParseNode_Id structBody = I("structBody");
    public readonly ParseNode_Id Declaration_structMember = I("structMemberDeclaration");

    public readonly ParseNode_Id interfaceBase = I("interfaceBase");
    public readonly ParseNode_Id interfaceBody = I("interfaceBody");

    public readonly ParseNode_Id enumBase = I("enumBase");
    public readonly ParseNode_Id enumBody = I("enumBody");
    ...
    private void AddRule()
    {
        ...
        _AR_(I("compilationUnit"), Many(Directive_ExternAlias) - Many(Directive_Using) - Many(Declaration_namespaceMember) - EOF
            , SemanticFlags.CompilationUnitScope);

        _AR_(Directive_ExternAlias, Seq("extern", "alias", IDENTIFIER, ";"), SemanticFlags.ExternAlias);
        _AR_(Directive_Using, "using" - (IF(IDENTIFIER - "=", Directive_UsingAlias) | Directive_UsingNamespace) - ";");
        _AR_(PARTIAL, IF(s => s.TokenScanner.Current.text == "partial", IDENTIFIER) | "partial", 0, true);
        _AR_(Declaration_namespaceMember,
            Declaration_Namespace | (Attributes - Modifiers - Alt(
                Seq(Opt(PARTIAL), I("classDeclaration") | I("structDeclaration") | I("interfaceDeclaration")),
                I("enumDeclaration"), I("delegateDeclaration"))) | ".NAMESPACEBODY");

        _AR_(Declaration_Namespace, "namespace" - qualifiedIdentifier - Body_Namespace - Opt(";"), SemanticFlags.Declaration_Namespace);
        _AR_(qualifiedIdentifier, NAME - Many(Lit(".") - NAME));
        _AR_(Body_Namespace,
            "{" - Many(Directive_ExternAlias) - Many(Directive_Using) - Many(Declaration_namespaceMember) - "}"
        , SemanticFlags.NamespaceBodyScope);
        ...
        _AR_(Declaration_class,
            Seq("class", NAME, Opt(List_TypeParameter), Opt(classBase),
                    Opt(typeParameterConstraintsClauses), Body_Class, Opt(";")), SemanticFlags.ClassDeclaration | SemanticFlags.TypeDeclarationScope);
        _AR_(List_TypeParameter,
            "<" - Attributes - typeParameter - Many("," - Attributes - typeParameter) - ">");
        _AR_(typeParameter, NAME, SemanticFlags.TypeParameterDeclaration);

        _AR_(classBase, ":" - List_interfaceType, SemanticFlags.ClassBaseScope);
        _AR_(List_interfaceType, (Name_Type | "object") - Many("," - Name_Type), SemanticFlags.BaseListDeclaration);
        _AR_(Body_Class, "{" - Many(Declaration_classMember) - "}", SemanticFlags.ClassBodyScope);

        _AR_(Name_Member, qid);
        _AR_(Declaration_classMember,
            Seq(Attributes, Modifiers, Declaration_Constant | "void" - Declaration_method
                | IF(PARTIAL, PARTIAL - ("void" - Declaration_method | Declaration_class | Declaration_struct | Declaration_interface))
                | IF(IDENTIFIER - "(", Declaration_constructor)
                | Seq(Type, IF(Name_Member - "(", Declaration_method)
                    | IF(Name_Member - "{", Declaration_property)
                    | IF(Name_Type - "." - "this", Name_Type - "." - Declaration_indexer)
                    | IF(Type_Predefined - "." - "this", Type_Predefined - "." - Declaration_indexer) | Declaration_indexer | Declaration_Field | Declaration_operator)
                | Declaration_class | Declaration_struct | Declaration_interface
                | Declaration_enum | Declaration_delegate | Declaration_event | Declaration_conversionOperator)
            | Declaration_destructor | ".CLASSBODY") /*{ semantics = SemanticFlags.MemberDeclarationScope }*/;

        _AR_(Declaration_constructor, Declarator_constructor - constructorBody, SemanticFlags.MethodDeclarationScope | SemanticFlags.ConstructorDeclarator);
        _AR_(Declarator_constructor, IDENTIFIER - "(" - Opt(formalParameterList) - ")" - Opt(constructorInitializer));
        _AR_(constructorInitializer, ":" - (Lit("base") | "this") - arguments, SemanticFlags.ConstructorInitializerScope);
        _AR_(constructorBody, "{" - statementList - "}" | ";", SemanticFlags.MethodBodyScope);
        _AR_(Declaration_destructor, Declarator_destructor - destructorBody);
        _AR_(Declarator_destructor, "~" - Opt("extern") - IDENTIFIER - "(" - ")", SemanticFlags.DestructorDeclarator);
        _AR_(destructorBody, "{" - statementList - "}" | ";", SemanticFlags.MethodBodyScope);
        _AR_(Declaration_Constant, "const" - Type - Declarator_constants - ";");
        ...
        _AR_(Declaration_method, methodHeader - Body_Method, SemanticFlags.MethodDeclarationScope | SemanticFlags.MethodDeclarator);
        ...
        _AR_(Body_Method, "{" - statementList - "}" | ";", SemanticFlags.MethodBodyScope);
        _AR_(block, "{" - statementList - "}" | ";", SemanticFlags.CodeBlockScope);
        _AR_(statementList, Many(NIF(Seq("default", ":"), statement)));
        ...
        _AR_(localVariableInitializer, Expression | arrayInitializer | ".EXPECTEDTYPE", SemanticFlags.LocalVariableInitializerScope);
        ...
        _AR_(embeddedStatement,
            block | selectionStatement    // if, switch
            | iterationStatement    // while, do, for, foreach
            | jumpStatement         // break, continue, goto, return, throw
            | tryStatement | lockStatement | usingStatement
            | IF(
                s =>
                {
                    if (s.TokenScanner.Current.text != "yield")
                        return false;
            ...
            | IF(Lit("checked") - "{", checkedStatement)
            | IF(Lit("unchecked") - "{", uncheckedStatement)
            | expressionStatement  // expression!
            | ".STATEMENT"
        , SemanticFlags.CodeBlockScope);

        _AR_(lockStatement, Seq("lock", "(", Expression, ")", embeddedStatement));
        _AR_(checkedStatement, Seq("checked", block));
        _AR_(uncheckedStatement, Seq("unchecked", block));
        ...
        _AR_(switchSection, Many(switchLabel) - statement - statementList);
        ...
        _AR_(tryStatement, "try" - block - (catchClauses - Opt(finallyClause) | finallyClause));
        ...
        _AR_(specificCatchClause,
            Lit("catch") - "(" - Type_ExecptionClass - Opt(catchExceptionIdentifier) - ")" - block, SemanticFlags.SpecificCatchScope);
        _AR_(catchExceptionIdentifier, NAME, SemanticFlags.CatchExceptionParameterDeclaration);
        _AR_(generalCatchClause, "catch" - block);
        _AR_(finallyClause, "finally" - block);
        ...
        _AR_(Declaration_indexer, Lit("this") - "[" - formalParameterList - "]" - "{" - Declaration_accessors - "}", SemanticFlags.IndexerDeclaration | SemanticFlags.AccessorsListScope);
        _AR_(Declaration_property, Name_Member - "{" - Declaration_accessors - "}", SemanticFlags.PropertyDeclaration | SemanticFlags.AccessorsListScope);
        ...
        _AR_(Declaration_accessors,
            Attributes - Opt(accessorModifiers)
                - (IF(s => s.TokenScanner.Current.text == "get", Declaration_getAccessor - Opt(Attributes - Opt(accessorModifiers) - Declaration_setAccessor))
                | Declaration_setAccessor - Opt(Attributes - Opt(accessorModifiers) - Declaration_getAccessor)));
        _AR_(Declaration_getAccessor, GET - accessorBody, SemanticFlags.GetAccessorDeclaration);
        _AR_(Declaration_setAccessor, SET - accessorBody, SemanticFlags.SetAccessorDeclaration);
        _AR_(accessorBody, "{" - statementList - "}" | ";", SemanticFlags.AccessorBodyScope);

        _AR_(Declaration_event, "event" - Name_Type - (IF(Name_Member - "{", Declaration_eventWithAccessors) | Declarator_events - ";"));
        _AR_(Declaration_eventWithAccessors, Name_Member - "{" - Declaration_eventAccessors - "}", SemanticFlags.EventWithAccessorsDeclaration | SemanticFlags.AccessorsListScope);
        ...
        _AR_(Declaration_eventAccessors,
            Attributes - (
                IF(s => s.TokenScanner.Current.text == "add", Declaration_addAccessor - Attributes - Declaration_removeAccessor)
                | Declaration_removeAccessor - Attributes - Declaration_addAccessor));

        _AR_(ADD, IDENTIFIER | "add", 0, true);
        _AR_(REMOVE, IDENTIFIER | "remove", 0, true);
        _AR_(Declaration_addAccessor, ADD - accessorBody, SemanticFlags.AddAccessorDeclaration);
        _AR_(Declaration_removeAccessor, REMOVE - accessorBody, SemanticFlags.RemoveAccessorDeclaration);
        _AR_(Declaration_Field, Declarator_variables - ";");
        ...
        _AR_(Declaration_operator, Seq(Declarator_operator, operatorBody));
        ...
        _AR_(overloadableBinaryOperator,
            Lit("*") | "/" | "%" | "&" | "|" | "^" | "<<" | IF(Seq(">", ">"),
            Seq(">", ">")) | "==" | "!=" | ">" | "<" | ">=" | "<=");
        _AR_(Declaration_conversionOperator, Declarator_conversionOperator - operatorBody);
        ...
        _AR_(operatorBody, "{" - statementList - "}" | ";", SemanticFlags.MethodBodyScope);

        _AR_(Declaration_struct,
            "struct" - NAME - Opt(List_TypeParameter) - Opt(structInterfaces)
            - Opt(typeParameterConstraintsClauses) - structBody - Opt(";"), SemanticFlags.StructDeclaration | SemanticFlags.TypeDeclarationScope);
        _AR_(structInterfaces, ":" - List_interfaceType, SemanticFlags.StructInterfacesScope);
        _AR_(structBody, "{" - Many(Declaration_structMember) - "}", SemanticFlags.StructBodyScope);
        _AR_(Declaration_structMember, Seq(Attributes, Modifiers, Declaration_Constant
                | "void" - Declaration_method
                | IF(PARTIAL, PARTIAL - ("void" - Declaration_method | Declaration_class | Declaration_struct | Declaration_interface))
                | IF(IDENTIFIER - "(", Declaration_constructor)
                | Seq(Type,
                    IF(Name_Member - "(", Declaration_method)
                    | IF(Name_Member - "{", Declaration_property)
                    | IF(Name_Member - "." - "this", Name_Type - "." - Declaration_indexer)
                    | IF(Type_Predefined - "." - "this", Type_Predefined - "." - Declaration_indexer)
                    | Declaration_indexer | Declaration_Field | Declaration_operator)
                | Declaration_class | Declaration_struct | Declaration_interface | Declaration_enum
                | Declaration_delegate | Declaration_event | Declaration_conversionOperator | ".STRUCTBODY"));

        _AR_(Declaration_interface, "interface" - NAME - Opt(List_TypeParameter) - Opt(interfaceBase) -
           Opt(typeParameterConstraintsClauses) - interfaceBody - Opt(";"), SemanticFlags.InterfaceDeclaration | SemanticFlags.TypeDeclarationScope);
        _AR_(interfaceBase, ":" - List_interfaceType, SemanticFlags.InterfaceBaseScope);
        _AR_(interfaceBody, "{" - Many(Declaration_interfaceMember) - "}", SemanticFlags.InterfaceBodyScope);
        _AR_(Declaration_interfaceMember,
            Seq(Attributes, Modifiers,
                "void" - Declaration_interfaceMethod | Declaration_interfaceEvent | Seq(Type,
                    IF(Name_Member - "(", Declaration_interfaceMethod)
                    | IF(Name_Member - "{", Declaration_interfaceProperty)
                    | Declaration_interfaceIndexer) | ".INTERFACEBODY"));
        _AR_(Declaration_interfaceProperty, NAME - "{" - Declaration_interfaceAccessors - "}", SemanticFlags.InterfacePropertyDeclaration);
        _AR_(Declaration_interfaceMethod, NAME - Opt(List_TypeParameter) - "(" - Opt(formalParameterList) - ")"
                - Opt(typeParameterConstraintsClauses) - ";", SemanticFlags.MethodDeclarationScope | SemanticFlags.InterfaceMethodDeclaration);
        _AR_(Declaration_interfaceEvent, Seq("event", Name_Type, NAME, ";"), SemanticFlags.InterfaceEventDeclaration);
        _AR_(Declaration_interfaceIndexer, Seq("this", "[", formalParameterList, "]", "{", Declaration_interfaceAccessors, "}"), SemanticFlags.InterfaceIndexerDeclaration);
        _AR_(Declaration_interfaceAccessors, Seq(Attributes,
                IF(s => s.TokenScanner.Current.text == "get", Declaration_interfaceGetAccessor - Opt(Attributes - Declaration_interfaceSetAccessor))
                | Declaration_interfaceSetAccessor - Opt(Attributes - Declaration_interfaceGetAccessor)));
        _AR_(Declaration_interfaceGetAccessor, GET - ";", SemanticFlags.InterfaceGetAccessorDeclaration);
        _AR_(Declaration_interfaceSetAccessor, SET - ";", SemanticFlags.InterfaceSetAccessorDeclaration);

        _AR_(Declaration_enum,
            "enum" - NAME - Opt(enumBase) - enumBody - Opt(";")
        , SemanticFlags.EnumDeclaration | SemanticFlags.TypeDeclarationScope);
        _AR_(enumBase, Seq(":", Type_Int), SemanticFlags.EnumBaseScope);
        _AR_(enumBody, "{" - Opt(Declaration_enumMembers) - "}", SemanticFlags.EnumBodyScope);
        _AR_(Declaration_enumMembers,
            Seq(Declaration_enumMember,
                Many(NIF(Seq(",", "}") | "}", "," - Declaration_enumMember)), Opt(",")));
        _AR_(Declaration_enumMember, Attributes - NAME - Opt("=" - constantExpression), SemanticFlags.EnumMemberDeclaration);
        _AR_(Declaration_delegate,
            "delegate" - ("void" | Type) - NAME - Opt(List_TypeParameter)
                - "(" - Opt(formalParameterList) - ")" - Opt(typeParameterConstraintsClauses) - ";"
        , SemanticFlags.DelegateDeclaration | SemanticFlags.TypeDeclarationScope);
        ...
        _AR_(Expression, IF(unaryExpression - assignmentOperator, assignment) | nonAssignmentExpression);
        ...
        _AR_(qidStart, Type_Predefined | IF(IDENTIFIER - "<", NAME - List_TypeParameter) | IDENTIFIER - Opt("::" - IDENTIFIER));
        ...
        _AR_(lambdaExpressionBody, Expression | "{" - statementList - "}", SemanticFlags.LambdaExpressionBodyScope);
