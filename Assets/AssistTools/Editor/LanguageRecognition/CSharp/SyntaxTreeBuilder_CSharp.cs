...
public class SyntaxTreeBuilder_CSharp : SyntaxTreeBuilder
{
    private Parser_CSharp m_kParser = Parser_CSharp.Instance;
    ...
    {
        var clone = new SyntaxTreeBuilder_CSharp(m_kTokenScanner, ComplilationUnitScop)
        {
            //tokens = tokens,
